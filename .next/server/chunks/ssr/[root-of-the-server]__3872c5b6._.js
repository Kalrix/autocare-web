...
function HomePage() {
    ...
    const handleAdminLogin = async ()=>{
        setAdminError('');
        try {
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchFromAPI"])('/api/admin-users/login', {
                method: 'POST',
                body: JSON.stringify({
                    username: adminId,
    ...
    const handleStoreLogin = async ()=>{
        ...
        try {
            ...
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchFromAPI"])('/api/store-admin/login', {
                method: 'POST',
                body: JSON.stringify({
                    alias,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3872c5b6._.js.map