...
function CreateStorePage() {
    ...
    const handleSubmit = async ()=>{
        const { data: store, error: storeError } = await supabase.from("store_admin").insert([
            {
                ...storeDetails,
                type: storeType
            }
        ]).select().single();
        if (storeError) return alert("Store creation failed");
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cafe644a._.js.map