...
function LoginPage() {
    ...
    const handleLogin = async ()=>{
        setError('');
        const { data, error: fetchError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('admin_users').select('*').eq('username', username).eq('password', password) // 🔒 plaintext match (NOT secure for production)
        .single();
        if (fetchError || !data) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__82bda937._.js.map