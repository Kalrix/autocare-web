...
function CreateStorePage() {
    ...
    const fullStoreName = storeName?.trim() ? storeName.startsWith("AutoCare24 -") ? storeName : `AutoCare24 - ${storeName}` : "";
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchData = async ()=>{
            try {
                const tasks = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchFromAPI"])(`/api/task-types?storeType=${storeType}`);
                // Normalize task ids
    ...
    const handleSubmit = async ()=>{
        try {
            ...
            const insertedStore = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchFromAPI"])("/api/store-admin", {
                method: "POST",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c5d2665e._.js.map