...
function CreateStorePage() {
        ...
        "CreateStorePage.useEffect": ()=>{
            const fetchData = {
                "CreateStorePage.useEffect.fetchData": async ()=>{
                    try {
                        const tasks = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchFromAPI"])(`/api/task-types?storeType=${storeType}`);
                        // Normalize task ids
                        const normalizedTasks = tasks.map({
                            "CreateStorePage.useEffect.fetchData.normalizedTasks": (t)=>({
                                    ...t,
                                    id: t.id || t._id
                                })
                        }["CreateStorePage.useEffect.fetchData.normalizedTasks"]);
    ...
    const handleSubmit = async ()=>{
        try {
            ...
            const insertedStore = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchFromAPI"])("/api/store-admin", {
                method: "POST",
...
_s(CreateStorePage, "lcjBAIFWPImgIkTVo/BVFqzCO58=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
...
//# sourceMappingURL=src_ddd455fc._.js.map